...
#include <asio/asio/basic_stream_socket.hpp>
#include <asio/asio/connect.hpp>
#include <asio/asio/executor.hpp>
#include <asio/asio/is_executor.hpp>
#include <boost/core/empty_value.hpp>
#include <chrono>
#include <limits>
#include <memory>

#define BOOST_ASIO_COMPLETION_TOKEN_FOR ASIO_COMPLETION_TOKEN_FOR
...
private:
        ...
        , boost::empty_value<RatePolicy>
    {
        ...
        template<class Executor3>
        void on_timer(Executor3 const& ex2);
